  ...
  const planData = [
    {
      name: 'Starter',
      code: 'starter',
      description: 'Best for small companies and single branch businesses',
      monthlyPrice: 0,
      yearlyPrice: 0,
      maxCompanies: 1,
      maxUsers: 5,
      ...
      suitableFor: ['Small companies', 'Single branch businesses'],
      features: [
        'Budget Management',
        'Forecast Management',
        'Excel Import',
    ...
    },
    {
      name: 'Business',
      code: 'business',
      description: 'Best for multi-branch and growing companies',
      monthlyPrice: 49.99,
      yearlyPrice: 499.99,
      maxCompanies: 3,
      maxUsers: 25,
      ...
      suitableFor: ['Multi-branch companies', 'Growing businesses'],
      features: [
        'Budget Management',
        'Forecast Management',
        'Excel Import',
    ...
    },
    {
      name: 'Enterprise',
      code: 'enterprise',
      description: 'Best for large manufacturers and enterprise organizations',
      monthlyPrice: 149.99,
      yearlyPrice: 1499.99,
      maxCompanies: 999,
      maxUsers: 999,
      maxBranches: 999,
      dashboardLevel: 'full',
      suitableFor: ['Large manufacturers', 'Enterprise organizations', 'Retail chains'],
      features: [
        'Budget Management',
        'Forecast Management',
        'Excel Import',
