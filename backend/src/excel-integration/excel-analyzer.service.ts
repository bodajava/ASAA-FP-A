...
export class ExcelAnalyzerService {
  ...
  private readonly FK_PATTERNS: Array<{
    ...
    {
      pattern: /^(company[_\s]?id|company[_\s]?code|company[_\s]?name)$/i,
      referenceSheet: 'companies',
      referenceColumn: 'code',
    },
    {
      pattern:
        /^(site[_\s]?id|site[_\s]?code|site[_\s]?name|branch[_\s]?code|warehouse[_\s]?code|factory[_\s]?code)$/i,
      referenceSheet: 'sites',
      referenceColumn: 'code',
    },
    {
      pattern: /^(unit[_\s]?id|unit[_\s]?symbol|uom)$/i,
      referenceSheet: 'units',
      referenceColumn: 'symbol',
    },
    {
      pattern: /^(account[_\s]?code|gl[_\s]?code|account[_\s]?number)$/i,
      referenceSheet: 'accounts',
      referenceColumn: 'code',
    },
    {
      pattern:
        /^(cost[_\s]?center[_\s]?code|cc[_\s]?code|department[_\s]?code)$/i,
      referenceSheet: 'costcenters',
      referenceColumn: 'code',
    },
    {
      pattern: /^(category[_\s]?id|category[_\s]?name|product[_\s]?category)$/i,
      referenceSheet: 'productcategories',
      referenceColumn: 'name',
    },
    {
      pattern:
        /^(supplier[_\s]?id|supplier[_\s]?code|supplier[_\s]?name|vendor[_\s]?code|vendor[_\s]?name)$/i,
      referenceSheet: 'suppliers',
      referenceColumn: 'code',
    },
    {
      pattern:
        /^(customer[_\s]?id|customer[_\s]?code|customer[_\s]?name|client[_\s]?code)$/i,
      referenceSheet: 'customers',
      referenceColumn: 'code',
    },
    {
      pattern:
        /^(product[_\s]?sku|sku|product[_\s]?code|item[_\s]?code|item[_\s]?sku)$/i,
      referenceSheet: 'products',
      referenceColumn: 'sku',
    },
    {
      pattern:
        /^(material[_\s]?code|material[_\s]?id|raw[_\s]?material[_\s]?code|rm[_\s]?code)$/i,
      referenceSheet: 'materials',
      referenceColumn: 'code',
    },
    {
      pattern: /^(bom[_\s]?id|recipe[_\s]?id|bill[_\s]?of[_\s]?material)$/i,
      referenceSheet: 'bomrecipes',
      referenceColumn: 'id',
    },
    {
      pattern: /^(scenario[_\s]?id|scenario[_\s]?name)$/i,
      referenceSheet: 'scenarios',
      referenceColumn: 'name',
    },
    {
      pattern:
        /^(budget[_\s]?cycle[_\s]?id|budget[_\s]?cycle[_\s]?name|budget[_\s]?name)$/i,
      referenceSheet: 'budgetcycles',
      referenceColumn: 'name',
    },
    {
      pattern:
        /^(forecast[_\s]?cycle[_\s]?id|forecast[_\s]?cycle[_\s]?name|forecast[_\s]?name)$/i,
      referenceSheet: 'forecastcycles',
      referenceColumn: 'name',
    },
    {
      pattern: /^(import[_\s]?id|import[_\s]?reference)$/i,
      referenceSheet: 'actualimports',
      referenceColumn: 'id',
    },
    {
      pattern: /^(customer[_\s]?code|client[_\s]?code)$/i,
      referenceSheet: 'customers',
      referenceColumn: 'code',
    },
  ];
  ...
  private readonly SHEET_MODULE_MAP: Array<{
    pattern: RegExp;
    module: string;
    description: string;
  }> = [
    {
      pattern: /^compan(y|ies)$/i,
      module: 'companies',
    ...
    {
      pattern: /^cost[_\s]?center(s)?$/i,
      module: 'costcenters',
      description: 'Cost centers / departments',
    },
    {
      pattern: /^product[_\s]?categor(y|ies)$/i,
    ...
    {
      pattern: /^supplier(s)?|vendor(s)?$/i,
      module: 'suppliers',
      description: 'Supplier / vendor master data',
    },
    {
      pattern: /^material(s)?|raw[_\s]?material(s)?$/i,
      module: 'materials',
    ...
    {
      pattern: /^bom[_\s]?recipe(s)?|bill[_\s]?of[_\s]?material(s)?|bom$/i,
      module: 'bomrecipes',
      description: 'Bill of materials',
    },
    {
      pattern: /^bom[_\s]?line(s)?|bom[_\s]?detail(s)?$/i,
      module: 'bomlines',
      description: 'BOM line items',
    },
    {
      pattern: /^production[_\s]?plan(s)?|manufacturing[_\s]?plan(s)?$/i,
      module: 'productionplans',
      description: 'Production planning',
    },
    {
      pattern: /^inventory|stock|warehouse[_\s]?stock/i,
      module: 'inventory',
    ...
    {
      pattern: /^budget[_\s]?line(s)?|budget(s)?$/i,
      module: 'budgetlines',
      description: 'Budget data',
    },
    {
      pattern: /^forecast[_\s]?(line(s)?|qty|quantit(y|ies)|s)?$/i,
      module: 'forecastlines',
      description: 'Forecast data',
    },
    {
      pattern:
        /^actual(s)?|actual[_\s]?line(s)?|gl[_\s]?entry(s)?|journal[_\s]?entry(s)?|transaction(s)?$/i,
      module: 'actuallines',
      description: 'Actual transactions / GL entries',
    },
    {
      pattern: /^kpi[_\s]?target(s)?|kpi(s)?$/i,
      module: 'kpitargets',
    ...
    {
      pattern: /^promotion(s)?|discount(s)?|offer(s)?$/i,
      module: 'promotions',
      description: 'Promotions & discounts',
    },
    {
      pattern:
        /^headcount[_\s]?plan(s)?|hr[_\s]?plan(s)?|staffing[_\s]?plan(s)?$/i,
      module: 'headcountplans',
      description: 'Headcount planning',
    },
    {
      pattern: /^notification[_\s]?rule(s)?|alert[_\s]?rule(s)?$/i,
      module: 'notificationrules',
      description: 'Notification rules',
    },
    {
      pattern:
        /^p&l|profit[_\s]?&[_\s]?loss|income[_\s]?statement|financial[_\s]?statement/i,
      module: 'actuallines',
      description: 'P&L data (maps to actual transactions)',
    },
    {
      pattern: /^selling[_\s]?price(s)?|price[_\s]?list|customer[_\s]?price/i,
      module: 'products',
      description: 'Selling prices (updates product prices)',
    },
    {
      pattern: /^discount(s)?|commercial[_\s]?polic(y|ies)/i,
      module: 'promotions',
      description: 'Commercial policies / discounts',
    },
    {
      pattern: /^packaging|carton|weight[_\s]?per[_\s]?carton/i,
      module: 'materials',
    ...
    },
    {
      pattern: /^data$/i,
      module: 'actuallines',
      description: 'Generic data sheet (maps to actual transactions)',
    },
    {
      pattern: /^s&m|s[_\s]&[_\s]m|g&a|g[_\s]&[_\s]a|operating[_\s]?expense/i,
      module: 'actuallines',
      description: 'S&M / G&A expenses (maps to actuals)',
    },
    {
      pattern: /^hrv[_\s]?rate(s)?|bawadi[_\s]?rate(s)?|info(rmational)?/i,
      module: 'informational',
      description: 'Informational sheets (ignored)',
    },
  ];
  ...
  analyzeWorkbook(buffer: Buffer, fileName: string): WorkbookAnalysis {
    ...
    return {
      ...
      isReady:
        sheets.every((s) => s.isReady) &&
        globalWarnings.filter((w) => w.type === 'orphan_data').length === 0,
      totalRows,
    };
  }
  ...
  private analyzeSheet(
    ...
    const duplicateRules = this.buildDuplicateRules(
      columns,
      detectedModule || 'unknown',
    );
  ...
  private analyzeColumn(
    ...
    const fillRate =
      values.length > 0 ? (nonNull.length / values.length) * 100 : 0;
    ...
    return {
      ...
      isPotentialFK,
      references: fkMatch
        ? { sheet: fkMatch.referenceSheet, column: fkMatch.referenceColumn }
        : undefined,
  ...
  private detectColumnType(values: unknown[]): ColumnAnalysis['detectedType'] {
    ...
    const typeCount = [dates, booleans, currencies, numbers].filter(
      (n) => n / total > 0.2,
    ).length;
  ...
  private isDateString(s: string): boolean {
    ...
    const d = new Date(s);
    return (
      !isNaN(d.getTime()) && d.getFullYear() > 1990 && d.getFullYear() < 2100
    );
  }
  ...
  private isCurrencyString(s: string): boolean {
    return /^[$ۣEGP|USD|EUR|SAR|AED]?\s*[\d,]+\.?\d*$/.test(
      s.replace(/\s/g, ''),
    );
  }
      ...
      if (fk.pattern.test(normalizedKey)) {
        ...
        const refSheetExists = allSheetNames.some((name) =>
          name
            .toLowerCase()
            .replace(/[_\s-]/g, '')
            .includes(fk.referenceSheet.toLowerCase()),
        );
        if (refSheetExists) {
          return {
            referenceSheet: fk.referenceSheet,
  ...
  private isPotentialPrimaryKey(
    ...
    const keyPatterns =
      /^(id|code|sku|number|key|ref|reference|code|barcode|batch|serial)$/i;
  ...
  private mapToErpField(
    ...
    const mappings: Array<{
      ...
      {
        pattern: /^(id|row[_\s]?id|line[_\s]?id)$/i,
        field: 'id',
        confidence: 1,
      },
      {
        pattern:
          /^(code|account[_\s]?code|gl[_\s]?code|account[_\s]?number|number)$/i,
        field: 'code',
        confidence: 1,
      },
      {
        pattern:
          /^(sku|product[_\s]?sku|item[_\s]?sku|item[_\s]?code|product[_\s]?code)$/i,
        field: 'sku',
        confidence: 1,
      },
      {
        pattern:
          /^(name|description|title|item[_\s]?name|product[_\s]?name|material[_\s]?name)$/i,
        field: 'name',
        confidence: 0.9,
      },
      {
        pattern: /^(type|category|class|classification)$/i,
        field: 'type',
        confidence: 0.8,
      },
      {
        pattern:
          /^(price|cost|amount|rate|unit[_\s]?price|unit[_\s]?cost|purchase[_\s]?price|selling[_\s]?price|standard[_\s]?cost)$/i,
        field: 'price',
        confidence: 0.9,
      },
      {
        pattern:
          /^(quantity|qty|amount|volume|stock|balance|opening|closing)$/i,
        field: 'quantity',
        confidence: 0.8,
      },
      {
        pattern:
          /^(date|transaction[_\s]?date|effective[_\s]?date|start[_\s]?date|end[_\s]?date|due[_\s]?date|created[_\s]?at)$/i,
        field: 'date',
        confidence: 0.9,
      },
      { pattern: /^(currency|curr|ccy)$/i, field: 'currency', confidence: 1 },
      {
        pattern: /^(unit|uom|unit[_\s]?of[_\s]?measure|measure)$/i,
        field: 'unit',
        confidence: 0.9,
      },
      { pattern: /^(status|state)$/i, field: 'status', confidence: 0.8 },
      {
        pattern: /^(address|location|street|city|country|region|zip|postal)$/i,
        field: 'address',
        confidence: 0.7,
      },
      {
        pattern: /^(phone|telephone|mobile|fax)$/i,
        field: 'phone',
        confidence: 0.9,
      },
      { pattern: /^(email|e-mail|mail)$/i, field: 'email', confidence: 1 },
      {
        pattern: /^(notes|remarks|comment|comments|description)$/i,
        field: 'notes',
        confidence: 0.6,
      },
      {
        pattern: /^(month|period|period[_\s]?month|fiscal[_\s]?month)$/i,
        field: 'periodMonth',
        confidence: 0.9,
      },
      {
        pattern: /^(year|fiscal[_\s]?year)$/i,
        field: 'fiscalYear',
        confidence: 0.9,
      },
      {
        pattern:
          /^(amount|total|sum|value|budget[_\s]?amount|forecast[_\s]?amount)$/i,
        field: 'amount',
        confidence: 0.9,
      },
      {
        pattern: /^(weight|weight[_\s]?kg|net[_\s]?weight|gross[_\s]?weight)$/i,
        field: 'weight',
        confidence: 0.9,
      },
      { pattern: /^(version|ver)$/i, field: 'version', confidence: 0.9 },
      {
        pattern: /^(is[_\s]?active|active|enabled)$/i,
        field: 'isActive',
        confidence: 0.9,
      },
      {
        pattern: /^(parent[_\s]?id|parent[_\s]?code|parent[_\s]?name)$/i,
        field: 'parentId',
        confidence: 0.8,
      },
      {
        pattern:
          /^(site[_\s]?code|branch[_\s]?code|warehouse[_\s]?code|factory[_\s]?code)$/i,
        field: 'siteCode',
        confidence: 0.9,
      },
      {
      ...
      {
        pattern: /^(supplier[_\s]?code|vendor[_\s]?code)$/i,
        field: 'supplierCode',
        confidence: 0.9,
      },
      {
        pattern:
          /^(material[_\s]?code|rm[_\s]?code|raw[_\s]?material[_\s]?code)$/i,
        field: 'materialCode',
        confidence: 0.9,
      },
      {
        pattern: /^(product[_\s]?sku|product[_\s]?code|item[_\s]?sku)$/i,
        field: 'productSku',
        confidence: 0.9,
      },
      {
        pattern: /^(yield[_\s]?%|yield[_\s]?pct|yield[_\s]?percent)$/i,
        field: 'yieldPct',
        confidence: 1,
      },
      {
        pattern: /^(waste[_\s]?%|wastage[_\s]?%|waste[_\s]?pct)$/i,
        field: 'wastagePct',
        confidence: 1,
      },
      {
        pattern: /^(discount[_\s]?%|discount[_\s]?pct)$/i,
        field: 'discountPct',
        confidence: 1,
      },
      {
        pattern: /^(credit[_\s]?limit)$/i,
        field: 'creditLimit',
        confidence: 1,
      },
      {
        pattern: /^(payment[_\s]?terms|terms)$/i,
        field: 'paymentTerms',
        confidence: 0.9,
      },
      {
        pattern: /^(legal[_\s]?name|company[_\s]?name)$/i,
        field: 'legalName',
        confidence: 0.8,
      },
      {
        pattern: /^(industry[_\s]?type|industry)$/i,
        field: 'industryType',
        confidence: 0.9,
      },
      {
        pattern: /^(tax[_\s]?number|vat[_\s]?number|tin)$/i,
        field: 'taxNumber',
        confidence: 1,
      },
      {
        pattern: /^(fiscal[_\s]?year[_\s]?start[_\s]?month)$/i,
        field: 'fiscalYearStartMonth',
        confidence: 1,
      },
      {
        pattern: /^(driver[_\s]?type)$/i,
        field: 'driverType',
        confidence: 0.9,
      },
      { pattern: /^(kpi[_\s]?name|kpi)$/i, field: 'kpiName', confidence: 0.9 },
      {
        pattern: /^(kpi[_\s]?category)$/i,
        field: 'kpiCategory',
        confidence: 0.9,
      },
      {
        pattern: /^(target[_\s]?value|target)$/i,
        field: 'targetValue',
        confidence: 0.9,
      },
      {
        pattern: /^(actual[_\s]?value|actual)$/i,
        field: 'actualValue',
        confidence: 0.9,
      },
      {
        pattern: /^(from[_\s]?currency|source[_\s]?currency)$/i,
        field: 'fromCurrency',
        confidence: 1,
      },
      {
        pattern: /^(to[_\s]?currency|target[_\s]?currency)$/i,
        field: 'toCurrency',
        confidence: 1,
      },
      {
        pattern: /^(exchange[_\s]?rate|rate)$/i,
        field: 'rate',
        confidence: 0.9,
      },
      {
        pattern: /^(rate[_\s]?date|fx[_\s]?date)$/i,
        field: 'rateDate',
        confidence: 1,
      },
      {
        pattern: /^(snapshot[_\s]?date|inventory[_\s]?date)$/i,
        field: 'snapshotDate',
        confidence: 1,
      },
      {
        pattern: /^(batch[_\s]?number|batch)$/i,
        field: 'batchNumber',
        confidence: 0.9,
      },
      { pattern: /^(barcode|upc|ean|gtin)$/i, field: 'barcode', confidence: 1 },
      {
        pattern: /^(min[_\s]?stock|minimum[_\s]?stock|safety[_\s]?stock)$/i,
        field: 'minStock',
        confidence: 0.9,
      },
      {
        pattern: /^(reorder[_\s]?point|reorder)$/i,
        field: 'reorderPoint',
        confidence: 0.9,
      },
      {
        pattern: /^(material[_\s]?type|type[_\s]?of[_\s]?material)$/i,
        field: 'materialType',
        confidence: 0.9,
      },
      {
        pattern: /^(product[_\s]?type|type[_\s]?of[_\s]?product)$/i,
        field: 'productType',
        confidence: 0.9,
      },
      {
        pattern: /^(customer[_\s]?type|type[_\s]?of[_\s]?customer)$/i,
        field: 'customerType',
        confidence: 0.9,
      },
      {
        pattern: /^(supplier[_\s]?type|vendor[_\s]?type)$/i,
        field: 'supplierType',
        confidence: 0.9,
      },
    ];
  ...
  private isLikelyRequired(col: ColumnAnalysis, module: string): boolean {
    const requiredPatterns =
      /^(id|code|sku|name|type|account[_\s]?code|transaction[_\s]?date|amount|period[_\s]?month|fiscal[_\s]?year)$/i;
    ...
    for (const col of columns) {
      ...
      if (col.detectedType === 'mixed') {
        warnings.push({
          ...
          suggestion:
            'All values will be treated as text. Consider standardizing the column.',
        });
      }
    ...
    for (const sheet of sheets) {
      if (!sheet.detectedModule || sheet.detectedModule === '') {
        warnings.push({
          ...
          suggestion:
            'Review the sheet name or manually map it to the correct module',
        });
      }
    }
